...
https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/metadata/Metadata.html#getNodes--[Metadata#getNodes] returns all the nodes known to the driver when the metadata was retrieved;
...
On the other hand, the https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/metadata/Node.html[Node] object is mutable;
