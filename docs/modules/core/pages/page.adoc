...
* offset queries: emulated client-side with https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/paging/OffsetPager.html[OffsetPager] (*this comes with important performance trade-offs, make sure you read and understand the full documentation below*).
...
To avoid this problem, the driver's asynchronous API now returns a dedicated https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html[AsyncResultSet];
...
If you want additional safety, the driver also provides a "safe" wrapper around the raw value: https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/cql/PagingState.html[PagingState].
...
The driver provides a utility to emulate offset queries on the client side: https://docs.datastax.com/en/drivers/java/4.17/com/datastax/oss/driver/api/core/paging/OffsetPager.html[OffsetPager].
